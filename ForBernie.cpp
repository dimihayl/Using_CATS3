...
//&UMTRS1::Source
        ...
        AB_pp.SetAnaSource(MemberSourceForwarder, &Stable_pp, 4);
    ...
    if(vSource==6||vSource==8){
        ...
        AB_pp.SetAnaSource(MemberSourceForwarder, &MSGEMTS_pp);
        AB_pp.SetUseAnalyticSource(true);
        AB_pp.SetThetaDependentSource(false);
    }
    else if(vSource==9){
        ...
        AB_pp.SetAnaSource(MemberSourceForwarder, &CleverLevy_pp, 2);
...
//AB_pp.SetMaxNumThreads(1);
    ...
    if(vSource==0){
        ...
        AB_pL.SetAnaSource(MemberSourceForwarder, &Stable_pL, 4);
    ...
    if(vSource==6||vSource==8){
        ...
        AB_pL.SetAnaSource(MemberSourceForwarder, &MSGEMTS_pL);
        AB_pL.SetUseAnalyticSource(true);
        AB_pL.SetThetaDependentSource(false);
    }
    else if(vSource==9){
        ...
        AB_pL.SetAnaSource(MemberSourceForwarder, &CleverLevy_pL, 2);
    ...
    InitHaidenbauerNLO("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/Haidenbauer/pLambdaNLO/",AB_pL,&WaveFunctionU,&PhaseShifts,&RadBins,NumRadBins,00,600);
...
//AB_pL.SetMaxNumThreads(1);
    ...
    if(vSource==0){
        ...
        AB_pXim.SetAnaSource(MemberSourceForwarder, &Stable_pXim, 4);
    ...
    if(vSource==6||vSource==8){
        ...
        AB_pXim.SetAnaSource(MemberSourceForwarder, &MSGEMTS_pXim);
        AB_pXim.SetUseAnalyticSource(true);
        AB_pXim.SetThetaDependentSource(false);
    }
    else if(vSource==9){
        ...
        AB_pXim.SetAnaSource(MemberSourceForwarder, &CleverLevy_pXim, 2);
...
//AB_pXim.SetMaxNumThreads(1);
    ...
    if(vSource==0){
        ...
        AB_pXim1530.SetAnaSource(MemberSourceForwarder, &Stable_pXim, 4);
        ...
        AB_pXim1530.SetAnaSource(MemberSourceForwarder, &CleverLevy_pXim, 2);
...
void RUN2_main2(const unsigned& NumIter, const unsigned& NumJobs, const unsigned& JobID){
    ...
    const TString OutputDir = "/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/Using_CATS2/OutputRun2/TestOutput/";
...
//the 0 iter is always the default!
    for(unsigned uIter=FirstIter; uIter<=LastIter; uIter++){
        ...
        //! DATA FILE
        TString OliFileName_pp =
            DataPeriod=="pp13TeV"?TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pp_13TeV/Sample5/AnalysisResults_AndiBernieSystME_CkProtonProton_%u.root",vCutID):
            TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pPb_5TeV/Sample4/AnalysisResults_AndiBernieSystME_CkProtonProton_%u.root",vCutID);
        TString OliHistoName_pp = "hCkTotNormWeight";
        TFile* OliFile_pp = OliFileName_pp!=""?new TFile(OliFileName_pp, "read"):NULL;
        TH1F* OliHisto_pp = OliFile_pp?(TH1F*)OliFile_pp->Get(OliHistoName_pp):NULL;
        ...
        //!CHANGE PATH HERE
        TString SystErrFileName_pp =
            DataPeriod=="pp13TeV"?TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pp_13TeV/Sample6/C2totalsysPP.root"):
            TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pPb_5TeV/Sample3/C2totalsysPP.root");
        TString SystErrHistoName_pp = "C2totalsysPP";
        TFile* SystErrFile_pp = SystErrFileName_pp!=""?new TFile(SystErrFileName_pp, "read"):NULL;
        TH1F* SystErrHisto_pp = SystErrFile_pp?(TH1F*)SystErrFile_pp->Get(SystErrHistoName_pp):NULL;
        int NumSEB_pp = SystErrHisto_pp==NULL?0:SystErrHisto_pp->GetNbinsX();
        ...
        //!CHANGE PATH HERE
        TString OliFileName_pL =
            DataPeriod=="pp13TeV"?TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pp_13TeV/Sample5/AnalysisResults_AndiBernieSystME_CkProtonLambda_%u.root",vCutID):
            TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pPb_5TeV/Sample4/AnalysisResults_AndiBernieSystME_CkProtonLambda_%u.root",vCutID);
        TString OliHistoName_pL = "hCkTotNormWeight";
        TFile* OliFile_pL;
        if(OliFileName_pp==OliFileName_pL) OliFile_pL=OliFile_pp;
        else OliFile_pL = OliFileName_pL!=""?new TFile(OliFileName_pL, "read"):NULL;
        ...
        //!CHANGE PATH HERE
        TString SystErrFileName_pL =
            DataPeriod=="pp13TeV"?TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pp_13TeV/Sample6/C2totalsysPL.root"):
            TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pPb_5TeV/Sample3/C2totalsysPL.root");
        TString SystErrHistoName_pL = "C2totalsysPL";
        TFile* SystErrFile_pL = SystErrFileName_pL!=""?new TFile(SystErrFileName_pL, "read"):NULL;
        TH1F* SystErrHisto_pL = SystErrFile_pL?(TH1F*)SystErrFile_pL->Get(SystErrHistoName_pL):NULL;
        int NumSEB_pL = SystErrHisto_pL==NULL?0:SystErrHisto_pL->GetNbinsX();
        ...
        //!CHANGE PATH HERE
        TString OliFileName_LL =
            DataPeriod=="pp13TeV"?TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pp_13TeV/Sample5/AnalysisResults_AndiBernieSystME_CkLambdaLambda_%u.root",vCutID):
            TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pPb_5TeV/Sample4/AnalysisResults_AndiBernieSystME_CkLambdaLambda_%u.root",vCutID);
        TString OliHistoName_LL = "hCkTotNormWeight";
        TFile* OliFile_LL;
        if(OliFileName_pp==OliFileName_LL) OliFile_LL=OliFile_pp;
        else OliFile_LL = OliFileName_LL!=""?new TFile(OliFileName_LL, "read"):NULL;
        ...
        //!CHANGE PATH HERE
        TString SystErrFileName_LL =
            DataPeriod=="pp13TeV"?TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pp_13TeV/Sample6/C2totalsysLL.root"):
            TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pPb_5TeV/Sample3/C2totalsysLL.root");
        TString SystErrHistoName_LL = "C2totalsysLL";
        TFile* SystErrFile_LL = SystErrFileName_LL!=""?new TFile(SystErrFileName_LL, "read"):NULL;
        TH1F* SystErrHisto_LL = SystErrFile_LL?(TH1F*)SystErrFile_LL->Get(SystErrHistoName_LL):NULL;
        int NumSEB_LL = SystErrHisto_LL==NULL?0:SystErrHisto_LL->GetNbinsX();
        ...
        //!CHANGE PATH HERE
        TString OliFileName_pXim =
            DataPeriod=="pp13TeV"?TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pp_13TeV/Sample5/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID):
            TString::Format("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pPb_5TeV/Sample4/AnalysisResults_AndiBernieSystME_CkProtonXim_%u.root",vCutID);
        if(ExcludeXi) OliFileName_pXim="";
        TString OliHistoName_pXim = "hCkTotNormWeight";
//TString OliHistoName_pXim = "hCkPartNorm";
        TFile* OliFile_pXim;
        ...
        //!CHANGE PATH HERE
        TString SystErrFileName_pXim =
            DataPeriod=="pp13TeV"?"/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pp_13TeV/Sample6/C2totalsysPXi.root":
            "/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/ALICE_pPb_5TeV/Sample3/C2totalsysPXi.root";
        TString SystErrHistoName_pXim = "C2totalsysPXi";
        if(ExcludeXi) SystErrFileName_pXim="";
        TFile* SystErrFile_pXim = SystErrFileName_pXim!=""?new TFile(SystErrFileName_pXim, "read"):NULL;
        TH1F* SystErrHisto_pXim = SystErrFile_pXim?(TH1F*)SystErrFile_pXim->Get(SystErrHistoName_pXim):NULL;
    ...
    //ADVANCED***
        ...
        CATSparameters Source_pp(CATSparameters::tSource,3,true);
        Source_pp.SetParameters(&Pars_pp[3]);
        if(vSource==0){
            AB_pp.SetAnaSource(GaussSource, Source_pp);
            AB_pp.SetUseAnalyticSource(true);
        ...
        CATSparameters Source_pL(CATSparameters::tSource,3,true);
        Source_pL.SetParameters(&Pars_pL[3]);
        if(vSource==0){
            AB_pL.SetAnaSource(GaussSource, Source_pL);
            AB_pL.SetUseAnalyticSource(true);
        ...
        complex<double>**** WaveFunctionU; double*** PhaseShifts; double* RadBins; unsigned NumRadBins=0;
        InitHaidenbauerNLO("/home/dmihaylov/Dudek_Ubuntu/Work/Kclus/GeneralFemtoStuff/CorrelationFiles_2018/Haidenbauer/pLambdaNLO/",AB_pL,&WaveFunctionU,&PhaseShifts,&RadBins,NumRadBins,0,600);
        ...
        if(vPLmodel==0){
            ...
            AB_pL.SetShortRangePotential(0,0,fDlmPot,c_pLamPotPars1S0);
            AB_pL.SetShortRangePotential(1,0,fDlmPot,c_pLamPotPars3S1);
        }
        ...
        CATSparameters c_pXimPotParsI0S0(CATSparameters::tPotential,8,true);
        c_pXimPotParsI0S0.SetParameters(&pXimPotParsI0S0[2]);
        CATSparameters c_pXimPotParsI0S1(CATSparameters::tPotential,8,true);
        c_pXimPotParsI0S1.SetParameters(&pXimPotParsI0S1[2]);
        CATSparameters c_pXimPotParsI1S0(CATSparameters::tPotential,8,true);
        c_pXimPotParsI1S0.SetParameters(&pXimPotParsI1S0[2]);
        CATSparameters c_pXimPotParsI1S1(CATSparameters::tPotential,8,true);
        c_pXimPotParsI1S1.SetParameters(&pXimPotParsI1S1[2]);

        CATS AB_pXim;
        double Pars_pXi[6] = {0,0,0,GaussSourceSize*1.2,GaussSourceSize/1.2,0.5};
        CATSparameters Source_pXi(CATSparameters::tSource,3,true);
        Source_pXi.SetParameters(&Pars_pXi[3]);
        if(vSource==0){
            AB_pXim.SetAnaSource(GaussSource, Source_pXi);
            AB_pXim.SetUseAnalyticSource(true);
        ...
        CATSparameters Source_pXi1530(CATSparameters::tSource,3,true);
        Source_pXi1530.SetParameters(&Pars_pXim1530[3]);
        if(vSource==0){
            AB_pXim1530.SetAnaSource(GaussSource, Source_pXi1530);
            AB_pXim1530.SetUseAnalyticSource(true);
